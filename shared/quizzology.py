...
class Quizzology:
    ...
    def __init__(
        self, quiz_store: Optional[QuizStore] = None, session_store: SessionStore = None
    ):
        self.session_store = session_store if session_store else prepare_session_store()
        if quiz_store:
        ...
        logger.info("Selected quiz store is %s", selected_store)
